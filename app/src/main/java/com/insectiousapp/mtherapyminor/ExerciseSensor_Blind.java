...
public class ExerciseSensor_Blind extends AppCompatActivity implements View.OnClickListener,SensorEventListener {
        ...
        switch (v.getId())
        {
            case R.id.btry_exercise_sensor:
                if(btry.getText().equals("Try it your self !!"))
                {
                    ...
                    Toast.makeText(ExerciseSensor_Blind.this, "Please start performing exercise", Toast.LENGTH_SHORT).show();
